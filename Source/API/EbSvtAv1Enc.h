...
typedef struct EbSvtAv1EncConfiguration {
     ...
     * 10 = 10 bit.
     *
     * Default is 10 for PSY Mod, mainline default is 8. */
    ...
    *
    * 0 is no denoising (default in PSY Mod)
    * 1 is full denoising
    */
    ...
    * Default is 0. */
     ...
     *
     * Default is 2 (Tune SSIM) for PSY Mod. Mainline SVT-AV1 uses 1 (Tune PSNR) as default.
     */
    uint8_t tune;
    ...
    * Default is 0.*/
     ...
     * Min value is 0.
     * Max value is 15.
     * Default is 0 in PSY Mod, mainline default is 8.
     */
