...
if(Git_FOUND AND EXISTS "${GIT_ROOT_DIR}/.git")
    ...
    execute_process(COMMAND
        ${GIT_EXECUTABLE}  -C ${GIT_ROOT_DIR}
        rev-list --right-only --count ${git_describe_output}..origin/v1.8.0
        RESULT_VARIABLE git_describe_status
    ...
    execute_process(COMMAND
        ${GIT_EXECUTABLE}  -C ${GIT_ROOT_DIR}
            rev-list ${git_describe_output}.. --count --committer=bex39
        RESULT_VARIABLE git_describe_status
    ...
    set(PACKAGE_VERSION_STRING "${git_describe_output}+${git_describe_mod}M-${git_describe_rev_id} [PSY Mod]")
    endif()
endif()
